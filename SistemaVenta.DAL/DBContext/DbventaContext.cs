...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-2M1PFTDM\\SQLEXPRESS;DataBase=DBVENTA;Integrated Security=true;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C18CEDA28");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F723836B8");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483FCC7980D");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107E9FAE77A");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EC8859687");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1323AF28ACD");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F761241BA08");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8113DC6CA");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE8C5FA33A");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A603D1BA08");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561414A159D1");
